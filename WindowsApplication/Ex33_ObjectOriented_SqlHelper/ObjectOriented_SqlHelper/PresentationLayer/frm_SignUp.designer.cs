namespace ObjectOriented_SqlHelper
{
    partial class frm_SignUp
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ExistsValidator = new ObjectOriented_SqlHelper.ExistsValidator(this.components);
			this.LengthValidator = new ObjectOriented_SqlHelper.LengthValidator(this.components);
			this.RequiredInfoValidator = new ObjectOriented_SqlHelper.RequiredInfoValidator(this.components);
