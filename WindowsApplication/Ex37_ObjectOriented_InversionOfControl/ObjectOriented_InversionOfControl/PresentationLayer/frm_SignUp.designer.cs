namespace ObjectOriented_InversionOfControl
{
    partial class frm_SignUp
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ExistsValidator = new ObjectOriented_InversionOfControl.ExistsValidator(this.components);
			this.LengthValidator = new ObjectOriented_InversionOfControl.LengthValidator(this.components);
			this.RequiredInfoValidator = new ObjectOriented_InversionOfControl.RequiredInfoValidator(this.components);
			...
			this.lbl_Hint.Size = new System.Drawing.Size(125, 12);
			this.lbl_Hint.TabIndex = 4;
			this.lbl_Hint.Text = "请输入新用户号、密码";
			// 
			// btn_SignUp
			// 
			this.btn_SignUp.Location = new System.Drawing.Point(62, 109);
